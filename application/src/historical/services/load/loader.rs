use crate::historical::database::create::{rollback_all_batches, InsertBatch};
use crate::historical::database::utils::get_lastest_mbp_id;
...
impl RecordLoader {
    pub async fn new(batch_size: usize, dataset: Dataset, pool: Arc<PgPool>) -> Result<Self> {
