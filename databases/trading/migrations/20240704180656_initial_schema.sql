...
CREATE TABLE backtest_StaticStats (
    ...
    avg_profit_percent FLOAT NOT NULL, 
    avg_gain FLOAT NOT NULL,
    avg_gain_percent FLOAT NOT NULL,
    avg_loss FLOAT NOT NULL,
    avg_loss_percent FLOAT NOT NULL,
    profitability_ratio FLOAT NOT NULL,
    profit_factor FLOAT NOT NULL,
    profit_and_loss_ratio FLOAT NOT NULL,
    total_fees FLOAT NOT NULL,  
    net_profit FLOAT NOT NULL, 
    beginning_equity FLOAT NOT NULL,  
    ending_equity FLOAT NOT NULL,  
    total_return FLOAT NOT NULL,
    daily_standard_deviation_percentage FLOAT NOT NULL,
    annual_standard_deviation_percentage FLOAT NOT NULL,
    max_drawdown_percentage_period FLOAT NOT NULL,
    max_drawdown_percentage_daily FLOAT NOT NULL,
